Feature: Constrained optimization with fixed budget constraints at Activity Level
  ...
  Scenario: Portfolio optimization for bolt hammer having fixed budget Constraint for few instruments
    ...
    And I assert that optimized instrument spend to be "9.946" % of actual spend